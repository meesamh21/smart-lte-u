...
../src/applications/test/voice-application-test-suite.cc 

CC_DEPS += \
./src/applications/test/udp-client-server-test.d \
./src/applications/test/voice-application-test-suite.d 

OBJS += \
./src/applications/test/udp-client-server-test.o \
./src/applications/test/voice-application-test-suite.o 
